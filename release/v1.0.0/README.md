...
Verify the model with `ollama run qwen2.5vl:7b "Reply with exactly: OLLAMA_READY"`. Full AI setup and troubleshooting are in [`LOCAL_OLLAMA.md`](LOCAL_OLLAMA.md).
