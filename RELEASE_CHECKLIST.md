...
- [x] Version and release notes identify this as stable `1.0.0`.
...
3. Create the GitHub release from `release/v1.0.0/GITHUB_RELEASE_BODY.md` after organizational approval.
4. Publish the stable `v1.0.0` tag and retain the final validation report privately.
