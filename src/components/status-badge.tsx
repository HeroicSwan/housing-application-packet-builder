...
const colors: Record<string, string> = {
  ...
  READY_FOR_REVIEW: "border-sky-200 bg-sky-50/70 text-sky-800", PENDING: "border-amber-200 bg-amber-50/70 text-amber-800", NEEDS_REVIEW: "border-amber-200 bg-amber-50/70 text-amber-800", COMPLETED_WITH_REVIEW: "border-amber-200 bg-amber-50/70 text-amber-800",
