export type PacketStatus = "DRAFT" | "READY_FOR_REVIEW" | "IN_REVIEW" | "ESCALATED" | "NEEDS_CORRECTION" | "APPROVED" | "ARCHIVED";

const transitions: Record<PacketStatus, readonly PacketStatus[]> = {
  DRAFT: ["READY_FOR_REVIEW"],
  READY_FOR_REVIEW: ["IN_REVIEW", "NEEDS_CORRECTION"],
  IN_REVIEW: ["ESCALATED", "NEEDS_CORRECTION", "APPROVED"],
  ESCALATED: ["IN_REVIEW", "NEEDS_CORRECTION"],
  NEEDS_CORRECTION: [],
  APPROVED: ["ARCHIVED"],
  ARCHIVED: [],
};
