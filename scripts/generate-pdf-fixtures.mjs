...
const fixtures = [
  ...
  ["jordan-rotated-identification.pdf", "FICTIONAL ROTATED IDENTIFICATION", ["Name: Jordan Rivera", "Date of birth: 05/08/1990", "Document type: State identification card", "Expiration date: 04/30/2025", "Synthetic rotated-scan fixture - not a real identity document"]],
  ["jordan-irregular-income.pdf", "FICTIONAL IRREGULAR INCOME", ["Employee: Jordan Rivera", "Pay frequency: Every two weeks", "Pay period: 06/01/2026 - 06/14/2026", "Gross pay: $1,235.40", "Synthetic irregular-income fixture - not employment evidence"]],
  ["jordan-household-letter.pdf", "FICTIONAL HOUSEHOLD LETTER", ["Applicant: Jordan Rivera", "Household member: Riley Rivera", "Relationship: Child", "Date of birth: 04/12/2017", "Synthetic household fixture - not an agency notice"]],
];
...
for (const [filename, title, rows] of fixtures) {
  ...
  if (filename.includes("rotated")) page.setRotation(degrees(90));
